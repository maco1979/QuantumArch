...
ARXIV_CATEGORIES = {
    ...
    'math': ['math.AG', 'math.AT', 'math.AP', 'math.ACT', 'math.CT', 'math.CA', 
             'math.CO', 'math.AC', 'math.CV', 'math.DG', 'math.DS', 'math.FA', 
             'math.GM', 'math.GN', 'math.GT', 'math.GR', 'math.HO', 'math.IT', 
             'math.KT', 'math.LO', 'math.MP', 'math.MG', 'math.NT', 'math.NA', 
             'math.OA', 'math.OC', 'math.PR', 'math.QA', 'math.RT', 'math.RA', 
             'math.SP', 'math.ST', 'math.SG'],
    ...
    def search_papers(
        ...
        search = arxiv.Search(
            ...
            sort_by=arxiv.SortCriterion.SubmittedDate if sort_by == "submittedDate" 
                    else arxiv.SortCriterion.Relevance if sort_by == "relevance"
    ...
    def download_pdf(self, paper: Paper, force: bool = False) -> str:
        ...
        try:
            ...
            result = self.client.results(
                arxiv.Search(f"id:{paper.arxiv_id}")
            ).__iter__().__next__()
...
def main():
    ...
    parser.add_argument('--category', '-c', type=str, default='cs', help='分类 (cs, physics, math, all)')
